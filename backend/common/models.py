...
class Assets(models.Model):
    ...
    def unrealized_gain_loss(
        ...
        fx_rate_eop = _fx_get_rate(self.currency, currency, date_as_of)["FX"] if currency else 1
        ...
        if self.type == ASSET_TYPE_CRYPTO:
            ...
            if self.is_bond:
                notional_lcl = self.get_effective_notional(date_as_of, investor, account_ids)
