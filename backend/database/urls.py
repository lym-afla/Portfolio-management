...
router.register(
    r"update-account-performance",
    UpdateAccountPerformanceViewSet,
    basename="update-account-performance",
)
...
urlpatterns = [
    ...
    path(
        ...
        name="api_security_form_structure",
    ),
    path("api/create-security/", views.api_create_security, name="api_create_security"),
    path(
        "api/update-security/<int:security_id>/",
        views.api_update_security,
        name="api_update_security",
    ),
    path(
        "api/delete-security/<int:security_id>/",
        views.api_delete_security,
        name="api_delete_security",
    ),
    path(
        "api/get-security-details/<int:security_id>/",
        views.api_get_security_details_for_editing,
        name="api_get_security_details",
    ),
    path(
        "api/securities/<int:security_id>/",
        views.api_get_security_detail,
        name="api_get_security_detail",
    ),
    path(
        "api/securities/<int:security_id>/price-history/",
        views.api_get_security_price_history,
        name="api_get_security_price_history",
    ),
    path(
        "api/securities/<int:security_id>/position-history/",
        views.api_get_security_position_history,
        name="api_get_security_position_history",
    ),
    path(
        "api/securities/<int:security_id>/transactions/",
        views.api_get_security_transactions,
