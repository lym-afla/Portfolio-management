...
class TestTransactionCreation:
    ...
    def test_transaction_creation_buy(self, user, broker, asset):
        ...
        assert transaction.broker == broker
        ...
        assert transaction.cash_flow == Decimal("-5000.00")
        assert transaction.commission == Decimal("5.00")
        assert transaction.comment == "Initial purchase"

    def test_transaction_creation_sell(self, user, broker, asset):
        ...
        assert transaction.cash_flow == Decimal("2750.00")

    def test_transaction_creation_dividend(self, user, broker, asset):
    ...
    def test_transaction_creation_interest(self, user, broker, asset):
    ...
    def test_transaction_creation_corporate_action(self, user, broker, asset):
    ...
    def test_transaction_string_representation(self, user, broker, asset):
    ...
    def test_transaction_currency_choices(self, user, broker, asset):
...
class TestTransactionValidation:
    ...
    def test_transaction_quantity_validation_buy(self, user, broker, asset):
    ...
    def test_transaction_quantity_validation_sell(self, user, broker, asset):
    ...
    def test_transaction_quantity_validation_non_trading(self, user, broker, asset):
    ...
    def test_transaction_cash_flow_direction(self, user, broker, asset):
    ...
    def test_transaction_commission_validation(self, user, broker, asset):
        """Test commission validation."""
        # Trading transactions can have commission
    ...
    def test_transaction_date_validation(self, user, broker, asset):
        ...
        assert past_transaction.date == past_date
        ...
        assert future_transaction.date == future_date
...
class TestTransactionCashFlowCalculations:
    ...
    def test_buy_transaction_cash_flow_calculation(self, user, broker, asset):
        ...
        expected_cash_flow = -(quantity * price) - commission
        ...
        assert transaction.cash_flow == expected_cash_flow

    def test_sell_transaction_cash_flow_calculation(self, user, broker, asset):
        ...
        expected_cash_flow = (abs(quantity) * price) - commission
    ...
    def test_zero_commission_transaction(self, user, broker, asset):
    ...
    def test_high_value_transaction(self, user, broker, asset):
        ...
        assert transaction.cash_flow == expected_cash_flow
        assert transaction.cash_flow < -Decimal("1000000")  # Should be over $1M

    def test_fractional_shares_transaction(self, user, broker, asset):
        ...
        assert abs(transaction.cash_flow - expected_cash_flow) < Decimal("0.000001")
...
class TestTransactionProcessing:
    ...
    def test_transaction_sequence_buy_sell(self, user, broker, asset):
    ...
    def test_transaction_sequence_multiple_buys(self, user, broker, asset):
        ...
        total_cost = sum(tx.cash_flow for tx in transactions)
    ...
    def test_transaction_sequence_dividend_reinvestment(self, user, broker, asset):
    ...
    def test_transaction_sequence_dollar_cost_averaging(self, user, broker, asset):
        ...
        total_invested = sum(abs(tx.cash_flow) for tx in transactions)
    ...
    def test_transaction_sequence_corporate_action_split(self, user, broker, asset):
...
class TestTransactionEdgeCases:
    ...
    def test_zero_quantity_transaction(self, user, broker, asset):
    ...
    def test_very_small_transaction(self, user, broker, asset):
        ...
        assert transaction.cash_flow == Decimal("-1.01")

    def test_negative_price_transaction(self, user, broker, asset):
    ...
    def test_transaction_same_day_multiple(self, user, broker, asset):
        ...
        tx2 = Transactions.objects.create(
            ...
            quantity=Decimal("50"),
            price=Decimal("51.00"),
            cash_flow=Decimal("-2550.00"),
            commission=Decimal("3.00"),
        )

        assert tx1.date == tx2.date == same_date
        assert tx1.id != tx2.id  # Should be different transactions

    def test_transaction_extreme_commission(self, user, broker, asset):
        ...
        high_commission_tx = Transactions.objects.create(
            ...
            quantity=Decimal("100"),
            price=Decimal("50.00"),
            cash_flow=Decimal("-6000.00"),  # Includes $1000 commission
        ...
        low_commission_tx = Transactions.objects.create(
            ...
            quantity=Decimal("-100"),
            price=Decimal("55.00"),
            cash_flow=Decimal("5499.99"),  # $0.01 commission
            commission=Decimal("0.01"),
        )
