...
urlpatterns = [
    ...
    path(
        "edit_broker/<int:item_id>/",
        views.edit_item,
        {"model_class": Brokers, "form_class": BrokerForm, "type": "broker"},
        name="edit_broker",
    ),
    path(
        "delete_broker/<int:item_id>/",
        views.delete_item,
        {"model_class": Brokers},
        name="delete_broker",
    ),
    path(
        "edit_transaction/<int:item_id>/",
        views.edit_item,
        {
    ...
    path(
        "delete_transaction/<int:item_id>/",
        views.delete_item,
        {"model_class": Transactions},
        name="delete_transaction",
    ),
    path(
        "edit_security/<int:item_id>/",
        views.edit_item,
        {"model_class": Assets, "form_class": SecurityForm, "type": "security"},
        name="edit_security",
    ),
    path(
        "delete_security/<int:item_id>/",
        views.delete_item,
        {"model_class": Assets},
        name="delete_security",
    ),
    path(
        "edit_price/<int:item_id>/",
        views.edit_item,
        {"model_class": Prices, "form_class": PriceForm, "type": "price"},
        name="edit_price",
    ),
    path(
        "delete_price/<int:item_id>/",
        views.delete_item,
        {"model_class": Prices},
        name="delete_price",
    ),
    path(
        "import_transactions_form/",
        views.import_transactions_form,
        name="import_transactions_form",
    ),
    path("import_transactions/", views.import_transactions, name="import_transactions"),
    path(
        "process_import_transactions/",
        views.process_import_transactions,
        name="process_import_transactions",
    ),
    ...
    path(
        "update_broker_performance/",
        views.update_broker_performance,
        name="update_broker_performance",
    ),
    path(
        "get_price_data_for_table/",
        views.get_price_data_for_table,
        name="get_price_data_for_table",
    ),
    path("prices/import_prices/", views.import_prices, name="import_prices"),
    path(
        "get_broker_securities/",
        views.get_broker_securities,
        name="get_broker_securities",
    ),
]
