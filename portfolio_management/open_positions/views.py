...
from utils import Irr, currency_format, entry_price, format_percentage, selected_brokers, effective_current_date, currency_format_dict_values
...
def open_positions(request):
    ...
    for item in portfolio_open:
        ...
        current_quote = item.current_price(effective_current_date)
        ...
        item.current_price = currency_format(current_quote.price, currency_target, number_of_digits)
